...
public class GsonUtil {
    ...
    public static final Type TOKEN_SET_INT = new TypeToken<Set<Integer>>() { }.getType();
    public static final Type TOKEN_SET_LONG = new TypeToken<Set<Long>>() { }.getType();
    public static final Type TOKEN_SET_STRING = new TypeToken<Set<String>>() { }.getType();
